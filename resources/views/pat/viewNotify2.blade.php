               ...
               <table class="table">
                  <tbody>
                     <tr>
                        ...
                        <td>{{ $data[0]->campaign_name }}</td>
                     </tr>
                     <tr>
                        <td><b>Vaccine Name</b></td>
                        <td>{{ $data[0]->vaccine_name }}</td>
                     </tr>
                     <tr>
                        <td><b>Campaign Date</b></td>
                        <td>{{ $data[0]->campaign_date }}</td>
                     </tr>
                     <tr>
                        <td><b>Start Age(in months)</b></td>
                        <td>{{ $data[0]->start_age }}</td>
                     </tr>
                     <tr>
                        <td><b>End Age(in months)</b></td>
                        <td>{{ $data[0]->end_age }}</td>
                     </tr>
                  </tbody>
               </table>
            </div>
            ...
            <form class="form-horizontal" role="form" >
               ...
               <div class="form-group">
                  <div class="col-sm-offset-1 col-sm-10">
                     <textarea disabled class="form-control" rows="10" id="comment" name="noti" >{{ $data[2]->msg }}  </textarea>
                  </div>
               </div>
               <div class="form-group">
