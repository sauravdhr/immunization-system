         ...
         <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
               <ul class="nav navbar-nav">
                  ...
                  <li class="{{ (Request::is('/approveEmployee') ? 'active' : '') }}" >
                     <a href="{{ URL::to('approveEmployee') }}"> Approve</br>Employees</a>
                  </li>
                  <li class="{{ (Request::is('/deleteCampaign') ? 'active' : '') }}" >
                     <a href="{{ URL::to('deleteCampaign') }}">Delete</br>Campaign</a>
                  </li>
                  <li class="{{ (Request::is('/deleteVaccine') ? 'active' : '') }}" >
                     <a href="{{ URL::to('deleteVaccine') }}">Delete</br>Vaccine</a>
                  </li>
